...
A demo of a multiple author post is shown in [Introducing Tailwind Nextjs Starter Blog post](/blog/introducing-yonatan).
...
```bash
git remote add template git@github.com:timlrx/yonatan.git

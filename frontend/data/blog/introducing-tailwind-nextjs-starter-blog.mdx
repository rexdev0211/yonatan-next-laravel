...
[![Deploy with Vercel](https://vercel.com/button)](https://vercel.com/new/git/external?repository-url=https://github.com/timlrx/yonatan)
...
Facing issues? Check the [FAQ page](https://github.com/timlrx/yonatan/wiki) and do a search on past issues. Feel free to open a new issue if none has been posted previously.
...
- [Demo Blog](https://yonatan.vercel.app/) - this repo
- [My personal blog](https://www.timlrx.com) - modified to auto-generate blog posts with dates
- [Aloisdg's cookbook](https://tambouille.vercel.app/) - with pictures and recipes!
- [GautierArcin's demo with next translate](https://yonatan-seven.vercel.app/) - includes translation of mdx posts, [source code](https://github.com/GautierArcin/yonatan/tree/demo/next-translate)
...
- [A markdown guide](https://yonatan.vercel.app/blog/github-markdown-guide)
- [Learn more about images in Next.js](https://yonatan.vercel.app/blog/guide-to-using-images-in-nextjs)
- [A tour of math typesetting](https://yonatan.vercel.app/blog/deriving-ols-estimator)
- [Simple MDX image grid](https://yonatan.vercel.app/blog/pictures-of-canada)
- [Example of long prose](https://yonatan.vercel.app/blog/the-time-machine)
- [Example of Nested Route Post](https://yonatan.vercel.app/blog/nested-route/introducing-multi-part-posts-with-nested-routing)

## Quick Start Guide

1. JS (official support) - `npx degit https://github.com/timlrx/yonatan.git` or TS (community support) - `npx degit timlrx/yonatan#typescript`
...
[MIT](https://github.com/timlrx/yonatan/blob/master/LICENSE) © [Timothy Lin](https://www.timrlx.com)
